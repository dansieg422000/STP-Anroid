...
public class Facebook {
    ...
    public static final String SINGLESIGNONDISABLED = "service_disabled";
    ...
    private boolean startSingleSignOn(Activity activity, String applicationId,
            String[] permission, int activityCode) {
    	String[] permissions = Arrays.copyOf(permission, permission.length);
     ...
     *            not require any permissions, pass an empty String array.
     */
	private void startDialogAuth(Activity activity, String[] permission) {
		String[] permissions = Arrays.copyOf(permission, permission.length);
    ...
    public void authorizeCallback(int requestCode, int resultCode, Intent data) {
        if (requestCode == mAuthActivityCode) {
            ...
            if (resultCode == Activity.RESULT_OK) {
                ...
                if (error != null) {
                    if (error.equals(SINGLESIGNONDISABLED)
		...
		final Messenger messageReceiver = new Messenger(new Handler() {
            ...
            public void handleMessage(Message msg) {
                ...
                if (token != null) {
                	...
                	// extract errors only if client wants them
