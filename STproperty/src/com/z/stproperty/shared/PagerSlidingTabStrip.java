...
public class PagerSlidingTabStrip extends HorizontalScrollView {
	...
	// @formatter:off
	private static final int[] ATTRS = new int[] { 14, Color.WHITE };
	// @formatter:on
	...
	private int indicatorColor = Color.parseColor("#20972a");
	...
	private int tabBackgroundResId = R.drawable.tab_backgrounds;
